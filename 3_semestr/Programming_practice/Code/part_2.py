...
def GetStringLikeoperands(inputStr):#Из входной строки сделать лист из операторов и цифр
...
def OperateWithMinusImputValue(inputListOf):#Некоторый костыль и проверка на то что нет слишком странных последовательностей операци
    IndexItemsForDelete = []
    i = 0
    ...
    try:
        ...
        while True:
            try:
                ...
                print("Ошибка при работе программы ",
